...
取得します。設計の詳細は[docs/architecture.md](docs/architecture.md)を参照してください。
...
リリースとデプロイの詳細は[docs/development.md](docs/development.md)を参照してください。
...
- [アーキテクチャとプロダクト仕様](docs/architecture.md)
- [開発・デプロイ手順](docs/development.md)
- [初期実現可能性調査](docs/feasibility.md)
- [複合語ナビゲーション](docs/compound-navigation.md)
- [構造一致検索](docs/structure-match-lookup.md)
